...
FACTORY_CODE_OWNED_WORKER_MODEL_IDS_JSON="${FACTORY_CODE_OWNED_WORKER_MODEL_IDS_JSON:-[\"custom:Proxy-Worker-Smart-Router-8\",\"custom:GPT-5.4-High-Proxy-2\",\"custom:Factory-Worker-GPT-5.5-High-8\",\"custom:Factory-Worker-GPT-5.4-High-8\",\"custom:Proxy-WorkerPool-8\"]}"
