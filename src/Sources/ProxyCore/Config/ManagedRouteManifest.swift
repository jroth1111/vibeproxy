...
public enum ManagedRouteManifest {
    ...
    public static let publicGLM5NVIDIADirectAlias = "glm5-nvidia"
    public static let publicKimiNVIDIADirectAlias = "kimi-k2.5-nvidia"
    public static let publicGLM5NVIDIASmartAlias = "glm5-nvidia-smart"
    public static let publicKimiNVIDIASmartAlias = "kimi-k2.5-nvidia-smart"
    public static let debugGLM5NVIDIADirectAlias = "glm5-nvidia-direct"
    ...
    public static let canonicalWorkerPoolCandidates = ["glm-5.1-zai", "glm-5.1-ollama-pro", "minimax-m2.7-ollama-pro", "muse-spark", "glm5-nvidia", "kimi-k2.5-nvidia", "minimax-m2.7-nvidia"]
